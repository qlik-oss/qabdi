...
This chart is based off of the Common helper chart hosts in the kubernetes incubator
helm chart repo. Documentation below.
...
spec:
  template:
    spec:
      containers:
      - 
{{ include "common.container" (list (set . "container" .Values.deployment.container) "mychart.deployment.container") | indent 8}}
{{- end -}}
